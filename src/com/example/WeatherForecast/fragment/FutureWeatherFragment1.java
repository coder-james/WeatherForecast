 ...
 */
public class FutureWeatherFragment1 extends Fragment {
    ...
    public static FutureWeatherFragment1 newInstance(String argument){
        Bundle bundle = new Bundle();
        bundle.putString(ARGUMENT, argument);
        FutureWeatherFragment1 futureWeatherFragment1 = new FutureWeatherFragment1();
        futureWeatherFragment1.setArguments(bundle);
        return futureWeatherFragment1;
    }
